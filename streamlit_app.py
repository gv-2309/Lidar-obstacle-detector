...
# Footer info
st.markdown("---")
st.markdown("👥 **Team:** Mind_Mesh")
st.markdown("💻 **Developers:** Vishnu V, Amrutha Dandigimath")
st.markdown("🎓 **College:** REVA University, Bengaluru")
st.markdown("📧 **Contact:** vishnuv2309@gmail.com")
